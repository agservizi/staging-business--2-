...
$listBaseUrl = asset('modules/opportunities/collaborator/list.php');
                ...
                <form class="row g-3 align-items-end" method="get">
                    ...
                    <div class="col-12 col-xl-3 d-flex flex-wrap gap-2 justify-content-xl-end">
                        ...
                        <?php if ($hasActiveFilters): ?>
                            <a class="btn btn-outline-secondary" href="<?php echo asset('modules/opportunities/collaborator/list.php'); ?>">
                                Reimposta
                            </a>
                        <?php endif; ?>
