    ...
    <main class="content-wrapper">
        <div class="page-toolbar mb-4">
            <div>
                ...
                <p class="text-muted mb-0">Richiesta bilanci e certificati camerali dalla Camera di Commercio</p>
            </div>
            ...
            <div class="col-lg-8">
                <div class="card ag-card">
                    <div class="card-header bg-transparent border-0">
                        <h2 class="h5 mb-0">
                            <i class="fa-solid fa-plus-circle text-warning me-2"></i>Nuova Richiesta
                        </h2>
                    </div>
                    <div class="card-body">
                            ...
                            <div class="row g-3">
                                <div class="col-md-6">
                                    <label for="tipo" class="form-label fw-semibold">
                                        <i class="fa-solid fa-certificate text-warning me-1"></i>Tipo Certificato *
                                    </label>
                                    <select class="form-select" id="tipo" name="tipo" required>
                                        <option value="">Seleziona tipo...</option>
                                        <option value="certificato_camera_commercio">Certificato Camera di Commercio</option>
                                        <option value="bilancio_deposito">Bilancio di Deposito</option>
                                        <option value="visura_societaria">Visura Societaria</option>
                                        <option value="certificato_stato_attivita">Certificato di Stato Attività</option>
                                        <option value="certificato_iscrizione">Certificato di Iscrizione</option>
                                    </select>
                                </div>

                                <div class="col-md-6">
                                    <label for="partita_iva" class="form-label fw-semibold">
                                        <i class="fa-solid fa-hashtag text-warning me-1"></i>Partita IVA *
                                    </label>
                                ...
                                <div class="col-md-6">
                                    <label for="ragione_sociale" class="form-label fw-semibold">
                                        <i class="fa-solid fa-building text-warning me-1"></i>Ragione Sociale *
                                    </label>
                                    <input type="text" class="form-control" id="ragione_sociale" name="ragione_sociale" required placeholder="Azienda Srl">
                                </div>

                                <div class="col-md-6">
                                    <label for="codice_fiscale" class="form-label fw-semibold">
                                        <i class="fa-solid fa-id-card text-warning me-1"></i>Codice Fiscale (opzionale)
                                    </label>
                                ...
                                <div class="col-md-6">
                                    <label for="comune" class="form-label fw-semibold">
                                        <i class="fa-solid fa-home text-warning me-1"></i>Comune *
                                    </label>
                                ...
                                <div class="col-md-6">
                                    <label for="provincia" class="form-label fw-semibold">
                                        <i class="fa-solid fa-map text-warning me-1"></i>Provincia *
                                    </label>
                                    <input type="text" class="form-control" id="provincia" name="provincia" required placeholder="MI">
                                </div>

                                <div class="col-md-6">
                                    <label for="anno_riferimento" class="form-label fw-semibold">
                                        <i class="fa-solid fa-calendar text-warning me-1"></i>Anno di Riferimento (opzionale)
                                    </label>
                                    <input type="number" class="form-control" id="anno_riferimento" name="anno_riferimento"
                                           min="1900" max="<?php echo date('Y') + 1; ?>" placeholder="<?php echo date('Y'); ?>">
                                </div>

                                <div class="col-md-6">
                                    <label for="numero_rea" class="form-label fw-semibold">
                                        <i class="fa-solid fa-hashtag text-warning me-1"></i>Numero REA (opzionale)
                                    </label>
                                    <input type="text" class="form-control" id="numero_rea" name="numero_rea" placeholder="MI-123456">
                                </div>

                                <div class="col-12">
                                    <label for="note" class="form-label fw-semibold">
                                        <i class="fa-solid fa-sticky-note text-warning me-1"></i>Note aggiuntive (opzionale)
                                    </label>
                ...
                <div class="card ag-card">
                    ...
                    <div class="card-body">
                        <div class="alert alert-info">
                            ...
                            <p class="mb-0 small">I certificati camerali vengono solitamente consegnati entro 3-7 giorni lavorativi.</p>
                        </div>
                        ...
                        <div class="alert alert-success">
                            ...
                            <ul class="mb-0 small">
                                <li>Certificato Camera di Commercio</li>
                                <li>Bilancio di Deposito</li>
                                <li>Visura Societaria</li>
                                <li>Certificato di Stato Attività</li>
                                <li>Certificato di Iscrizione</li>
                            </ul>
                        </div>
                    </div>
                </div>
...
document.getElementById('certificatoForm').addEventListener('submit', function(e) {
    ...
    .then(data => {
        ...
        if (data.success) {
            ...
            modalBody.innerHTML = '<div class="alert alert-success"><i class="fa-solid fa-check-circle me-2"></i>Richiesta certificato camerale inviata con successo! Sarà revisionata dall\'amministratore.</div>';
            this.reset();
        } else {
