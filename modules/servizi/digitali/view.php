                ...
                <div class="card ag-card h-100">
                    ...
                    <div class="card-body">
                        <dl class="row mb-0">
                            ...
                            <dd class="col-sm-7"><?php echo sanitize_output($movement['tipo_movimento']); ?></dd>
                            ...
                            <dd class="col-sm-7 fw-semibold <?php echo ((int) $movement['punti']) >= 0 ? 'text-success' : 'text-danger'; ?>">
                                <?php echo ((int) $movement['punti']) >= 0 ? '+' : ''; ?><?php echo number_format((int) $movement['punti'], 0, ',', '.'); ?> pt
                            </dd>
                            <dt class="col-sm-5">Saldo dopo il movimento</dt>
                            <dd class="col-sm-7"><?php echo number_format($currentPostBalance, 0, ',', '.'); ?> pt</dd>
                            <dt class="col-sm-5">Saldo precedente</dt>
                            <dd class="col-sm-7"><?php echo number_format($balanceBefore, 0, ',', '.'); ?> pt</dd>
                ...
                <div class="card ag-card h-100">
                    ...
                    <div class="card-body">
                        <dl class="row mb-0">
                            ...
                            <dd class="col-sm-7"><?php echo number_format($currentBalance, 0, ',', '.'); ?> pt</dd>
                        </dl>
                    </div>
                </div>
            </div>
