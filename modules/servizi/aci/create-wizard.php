...
$data = [
    ...
    'intestatario_codice_fiscale' => '',
    'intestatario_data_nascita' => '',
    'intestatario_luogo_nascita' => '',
    'intestatario_residenza' => '',
    'intestatario_email' => '',
    'intestatario_telefono' => '',
    'intestatario_ragione_sociale' => '',
    'intestatario_partita_iva' => '',
    'intestatario_codice_fiscale_giuridico' => '',
    'intestatario_sede_legale' => '',
    'targa' => '',
    'telaio' => '',
    'veicolo_tipo' => 'Auto',
    'veicolo_marca' => '',
    'veicolo_modello' => '',
    'veicolo_anno_immatricolazione' => '',
    'veicolo_alimentazione' => '',
    'veicolo_potenza_kw' => '',
    'veicolo_classe_ambientale' => '',
    'venditore_nome' => '',
    'venditore_codice_fiscale' => '',
    'venditore_indirizzo' => '',
    'acquirente_nome' => '',
    'acquirente_codice_fiscale' => '',
    'acquirente_indirizzo' => '',
    'venditore_acquirente_coincidono' => false,
    'diritti_aci' => '0.00',
    'imposta_bollo' => '0.00',
    'emolumenti' => '0.00',
    'compenso_agenzia' => number_format($defaultCompenso, 2, '.', ''),
    'totale' => number_format($defaultCompenso, 2, '.', ''),
...
function aci_has_upload(?array $files): bool
{
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (!aci_has_upload($_FILES['documento_identita'] ?? null)) {
        $errors[] = 'Documento identità intestatario obbligatorio.';
    }
    if (!aci_has_upload($_FILES['tessera_sanitaria'] ?? null)) {
        $errors[] = 'Tessera sanitaria obbligatoria.';
    }
    if (!aci_has_upload($_FILES['carta_circolazione'] ?? null)) {
        $errors[] = 'Carta di circolazione obbligatoria.';
    }
    ...
    if (!$errors) {
        ...
        $stmt = $pdo->prepare('INSERT INTO servizi_aci_pratiche (
            ...
            acquirente_codice_fiscale,
            acquirente_indirizzo,
            venditore_acquirente_coincidono,
            diritti_aci,
            imposta_bollo,
            emolumenti,
            compenso_agenzia,
                ...
                <form method="post" enctype="multipart/form-data" id="aci-wizard" novalidate>
                    ...
                    <div class="d-flex justify-content-between align-items-center mt-4">
                        ...
                        <div class="d-flex gap-2">
                            ...
                            <button class="btn btn-warning text-dark" type="submit" data-step-submit>Invia pratica</button>
                        </div>
                    </div>
                </form>
            </div>
