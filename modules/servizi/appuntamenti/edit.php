...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (!$errors) {
        ...
        header('Location: ' . appuntamenti_module_url('view', ['id' => $id, 'updated' => 1]));
        exit;
    }
}
...
<div class="flex-grow-1 d-flex flex-column min-vh-100">
    ...
    <main class="content-wrapper">
        <div class="mb-4">
            <a class="btn btn-outline-warning" href="<?php echo appuntamenti_module_url('view', ['id' => $id]); ?>"><i class="fa-solid fa-arrow-left"></i> Dettaglio appuntamento</a>
        </div>
            ...
            <div class="card-body">
                ...
                <form method="post" novalidate>
                    ...
                    <div class="d-flex justify-content-end gap-2 mt-4">
                        <a class="btn btn-secondary" href="<?php echo appuntamenti_module_url('view', ['id' => $id]); ?>">Annulla</a>
