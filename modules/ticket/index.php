...
?>
<div class="flex-grow-1 d-flex flex-column min-vh-100" data-ticket-csrf="<?php echo sanitize_output($csrfToken); ?>" data-ticket-base="<?php echo sanitize_output(asset('modules/ticket')); ?>">
