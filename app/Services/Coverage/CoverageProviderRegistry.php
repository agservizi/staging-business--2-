    ...
    private const PROVIDERS = [
        'fastweb_consumer' => [
            ...
            'actions' => [
                ...
                ['action' => 'wait_for', 'selector' => 'div[class*="res_" i]:not(.hidden), section[id*="result" i], section[class*="result" i], body', 'timeout' => 40],
                ['action' => 'pause', 'milliseconds' => 2000],
                ['action' => 'extract_text', 'selector' => 'div[class*="res_" i]:not(.hidden), section[id*="result" i], section[class*="result" i], body', 'as' => 'copertura'],
