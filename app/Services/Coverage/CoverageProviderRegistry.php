    ...
    private const PROVIDERS = [
        'fastweb_consumer' => [
            ...
            'actions' => [
                ...
                ['action' => 'type', 'selector' => 'input:is([name*="civ" i],[id*="civ" i],[placeholder*="civico" i])', 'field' => 'civic'],
                ['action' => 'type', 'selector' => 'input:is([name*="zip" i],[name*="cap" i],[id*="cap" i],[placeholder*="cap" i])', 'field' => 'cap'],
                ['action' => 'type', 'selector' => 'input:is([name*="city" i],[name*="comune" i],[placeholder*="comune" i])', 'field' => 'city'],
                ['action' => 'click', 'selector' => 'button:is([type="submit"],[data-testid*="search" i],[data-action*="cerca" i])', 'scroll' => true],
                ['action' => 'wait_for', 'selector' => 'section[id*="result" i], section[class*="result" i], body', 'timeout' => 30],
                ['action' => 'pause', 'milliseconds' => 2000],
                ['action' => 'extract_text', 'selector' => 'section[id*="result" i], section[class*="risult" i], body', 'as' => 'copertura'],
            ],
        ],
        'windtre_consumer' => [
